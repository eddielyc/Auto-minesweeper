...
首先会遍历所有的不完整的数字提示方块，进行Level 1和Level 2的推理，得到所有安全的操作（包括安全的点开和确信的插旗）。如果并没有任何安全的操作，则进行Level 3的推理（所以对于在解释[Level 3](https://github.com/eddielyc/Auto-minesweeper#%E6%8E%A8%E7%90%86%E5%88%86%E4%B8%BA%E4%B8%89%E4%B8%AA%E7%AD%89%E7%BA%A7)部分给出的例子不是特别恰当，因为在图中存在大量的使用Level 1和Level 2就能得到的安全操作，并不需要动用Level 3），得到精准概率后，如果存在安全操作则直接返回结果。如果无安全操作，则需要猜雷。
...
## Ref
[https://github.com/ztxz16/Mine](https://github.com/ztxz16/Mine)
